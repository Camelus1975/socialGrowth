export function initCalendarV3() {
  ...
  days.forEach(day => {
    ...
    html += \<h3 style="margin-top:0; color:var(--text-main); font-size:1rem; text-align:center;">\</h3>\;
    ...
    if (scheduledPosts[day]) {
      scheduledPosts[day].forEach(post => {
        ...
        html += \
          <div style="background:rgba(0,0,0,0.3); border-left: 3px solid \; border-radius:6px; padding:12px; margin-top:12px; font-size:0.85rem; color:var(--text-muted); cursor:pointer;">
            <div style="font-weight:bold; margin-bottom:4px; color:var(--text-main);">\ - \</div>
